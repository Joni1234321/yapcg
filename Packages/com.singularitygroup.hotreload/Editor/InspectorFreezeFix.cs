...
namespace SingularityGroup.HotReload.Editor
{
    ...
    public class InspectorFreezeFix
    {
        ...
        private static void OnSelectionChanged() {
            ...
            try {
                ...
                foreach (var inspector in Resources.FindObjectsOfTypeAll(inspectorType)) {
                    ...
                    var editors = (UnityEditor.Editor[])activeEditors.GetValue(tracker);
                    if (editors.Length == 0) {
                        continue;
                    }
        ...
        static void RefreshInspectors(global::System.Type inspectorType) {
            ...
            var allInspectors = allInspectorsField.GetValue(null) as global::System.Collections.IEnumerable;
        ...
        static PropertyInfo FindFieldInHierarchy(global::System.Type type, string fieldName) {
